...
test.describe("Cart", () => {
  test("cart page lists correct item names and prices", async ({
    cartWithItems,
    page,
  }) => {
  ...
  test("remove item from cart updates list and badge", async ({
    cartWithItems,
    page,
  }) => {
    const { inventoryPage, cartPage } = cartWithItems;
  ...
  test("checkout button navigates to step one", async ({
    cartWithItems,
    page,
  }) => {
    const { inventoryPage, cartPage } = cartWithItems;
  ...
  test("cart item price matches inventory listing price", async ({
    loggedInPage,
    cartPage,
    page,
  }) => {
  ...
  test("checkout with empty cart — documents actual app behavior", async ({
    loggedInPage,
    cartPage,
    page,
  }) => {
